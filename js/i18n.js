const translations = {
  es: {
    ...
    'hero.kicker': 'Software a medida para empresas',
    'hero.title': 'Automatizaciones con IA, ERPs a medida y páginas web profesionales',
    'hero.desc': 'Ayudamos a empresas a digitalizar procesos, ahorrar horas de trabajo y mejorar su presencia online con soluciones prácticas, personalizadas y enfocadas en resultados.',
    'hero.support': 'Desarrollamos automatizaciones inteligentes, sistemas ERP adaptados a cada negocio y páginas web preparadas para captar clientes y mejorar el posicionamiento en Google.',
  ...
  en: {
    ...
    'hero.kicker': 'Custom software for businesses',
    'hero.title': 'AI automations, custom ERPs and professional websites',
    'hero.desc': 'We help businesses digitize processes, save hours of work and improve their online presence with practical, tailored solutions focused on results.',
    'hero.support': 'We build intelligent automations, ERP systems tailored to each business and websites designed to attract clients and improve Google visibility.',
    'hero.btn': 'Contact us',
  ...
  ca: {
    ...
    'hero.kicker': 'Programes a mida per a empreses',
    'hero.title': 'Automatitzacions amb IA, ERPs a mida i pàgines web professionals',
    'hero.desc': 'Ajudem empreses a digitalitzar processos, estalviar hores de feina i millorar la seva presència online amb solucions pràctiques, personalitzades i enfocades a resultats.',
    'hero.support': 'Desenvolupem automatitzacions intel·ligents, sistemes ERP adaptats a cada negoci i webs preparades per captar clients i millorar el posicionament a Google.',
